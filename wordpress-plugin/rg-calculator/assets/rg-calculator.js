...
function c0() {
  ...
  function x(r, E, D, N, F) {
    ...
    else if (((Dl = W(r)), typeof Dl == "function"))
    ...
    jd ||
      ...
      (function (m) {
        ...
        var Nl = !1,
          ...
          Hl = -1;
        function q() {
          return _ ? !0 : !(m.unstable_now() - Hl < Al);
        }
        function X() {
          if (((_ = !1), Nl)) {
          ...
          (m.unstable_scheduleCallback = function (x, j, J) {
            ...
            return (
              ...
              J > vl
                ...
                : ((x.sortIndex = xl), M(A, x), Q || W || ((Q = !0), Nl || ((Nl = !0), yl()))),
              x
            );
          }),
...
` +
  ...
  function Di(l) {
    for (; l === kn; ) ((kn = na[--ua]), (na[ua] = null), (Ka = na[--ua]), (na[ua] = null));
    for (; l === ae; )
      ((ae = zt[--Et]),
        (zt[Et] = null),
        (Rt = zt[--Et]),
  ...
  function tu(l) {
    var t = ka;
    return ((ka += 1), ra === null && (ra = []), Rs(ra, l, t));
  }
  function Fa(l, t) {
  ...
  function Bs(l) {
    ...
    function f(h, o, g, T) {
      ...
      return L === ul
        ...
        : o !== null &&
          ...
          : ((o = Wn(g.type, g.key, g.props, null, h.mode, T)), Fa(o, g), (o.return = h), o);
    }
    function y(h, o, g, T) {
      return o === null ||
        o.tag !== 4 ||
    ...
    function z(h, o, g) {
      ...
      if (typeof o == "object" && o !== null) {
        switch (o.$$typeof) {
          case W:
            return ((g = Wn(o.type, o.key, o.props, null, h.mode, g)), Fa(g, o), (g.return = h), g);
          case Q:
          ...
          case W:
            l: {
              ...
              g.type === ul
                ...
                : ((T = Wn(g.type, g.key, g.props, null, h.mode, T)),
                  Fa(T, g),
                  (T.return = h),
                  (h = T));
            }
  ...
  function Js(l, t, e, a) {
    ((t.value = e), (t.getSnapshot = a), Ws(t) && ks(l));
  }
  function ws(l, t, e) {
    return e(function () {
      Ws(t) && ks(l);
      ...
      if (
        ...
        try {
          ...
          if (((n.hasEagerState = !0), (n.eagerState = c), dt(c, i)))
            return (Jn(l, t, n, 0), Tl === null && Kn(), !1);
        } catch {}
  ...
  function am(l, t, e) {
    ...
    if (u !== null) {
      ...
      if ((wi(t), n))
        ...
        if (((a = Tl), a !== null && ((i = Of(a, e)), i !== 0 && i !== u.retryLane)))
  ...
  function Vo(l, t, e) {
    ...
    if (f !== null && ((c = f.dehydrated), c !== null)) {
      if (u)
        ...
        if (((i = Tl), i !== null && ((a = Of(i, e)), a !== 0 && a !== f.retryLane)))
  ...
  var wt = !1,
    ...
    Ql = null;
  function cm(l, t) {
    if (((l = l.containerInfo), (Wc = Gu), (l = ds(l)), bi(l))) {
    ...
    for (kc = { focusedElem: l, selectionRange: e }, Gu = !1, Ql = t; Ql !== null; )
  ...
  function er(l, t, e) {
    ...
    switch (e.tag) {
      ...
      case 26:
      case 5:
        (kt(l, e), t === null && a & 4 && Io(e), a & 512 && fn(e, e.return));
        break;
      case 12:
        kt(l, e);
        break;
      ...
      case 22:
        if (((a = e.memoizedState !== null || wt), !a)) {
          ...
          var u = Gl;
          ((wt = a),
            (Gl = t) && !u ? Ft(l, e, (e.subtreeFlags & 8772) !== 0) : kt(l, e),
            (wt = n),
            (Gl = u));
        }
        break;
  ...
  function nr(l, t, e) {
    ...
    switch (e.tag) {
      ...
      case 21:
        ...
        break;
      case 22:
        ((Gl = (a = Gl) || e.memoizedState !== null), Wt(l, t, e), (Gl = a));
        break;
      default:
        Wt(l, t, e);
    }
  ...
  function ft(l, t, e) {
    (((l === Tl && (ml === 2 || ml === 9)) || l.cancelPendingCommit !== null) &&
      ...
      Ra(l, e),
      ((dl & 2) === 0 || l !== Tl) &&
        (l === Tl && ((dl & 2) === 0 && (Ze |= e), Cl === 4 && ve(l, al, vt, !1)), Ht(l)));
  }
  function vr(l, t, e) {
  ...
  function hm(l, t) {
    ...
    var a = xr(),
      n = Tr();
    Tl !== l || al !== t ? ((zu = null), (Tu = st() + 500), xa(l, t)) : (pa = Ua(l, t));
    l: do
      try {
        if (ml !== 0 && tl !== null) {
          t = tl;
  ...
  function Br(l, t) {
    ...
    var a = al;
    return (
      (a = Rn(l, l === Tl ? a : 0, l.cancelPendingCommit !== null || l.timeoutHandle !== -1)),
      a === 0
        ? null
        : (vr(l, a, t),
          Hr(l, st()),
  ...
  var Wr = typeof setTimeout == "function" ? setTimeout : void 0,
    ...
    Um =
      typeof queueMicrotask == "function"
        ...
        : typeof kr < "u"
          ? function (l) {
              return kr.resolve(null).then(l).catch(Rm);
            }
          : Wr;
  function Rm(l) {
    setTimeout(function () {
...
const v0 = y0(),
  Ml = (m) => v0 + m,
  zl = {
    groundLevel: Ml("use-deck.jpg"),
    balcony: Ml("use-balcony.jpg"),
    pool: Ml("use-pool.jpg"),
    stairs: Ml("use-stairs.jpg"),
    corners: Ml("feature-corner.jpg"),
    gates: Ml("feature-gate.jpg"),
    toughened: Ml("glass-12mm.jpg"),
    laminated: Ml("glass-laminated.jpg"),
    ...
    viking: Ml("fix-viking.jpg"),
    chrome: Ml("finish-chrome.jpg"),
    matteBlack: Ml("finish-black.jpg"),
    brushedChrome: Ml("finish-brushed.jpg"),
    powderCoated: Ml("finish-brass.jpg"),
    notSure: Ml("not-sure.jpg"),
    substrateTimber: Ml("substrate-timber.jpg"),
    substrateConcrete: Ml("substrate-concrete.jpg"),
    substrateTile: Ml("substrate-tile.jpg"),
    substrateSteel: Ml("substrate-steel.jpg"),
  };
function p0(m, M = Sf) {
  ...
  const Y = [
      ...
      },
      {
        ...
        content: s.jsxs(s.Fragment, {
          children: [
            s.jsx(pf, { src: zl.balcony, alt: "Glass fencing project" }),
        ...
        : [
            {
              ...
              content: s.jsxs(s.Fragment, {
                children: [
                  s.jsx(pf, { src: zl.corners, alt: "How to count corners" }),
                  s.jsx(An, {
                    label: "Corners",
                    value: m.corners,
                    min: 0,
